    ...
    <div>
      <Card body style={style.card}>
        ...
        <Row>
          ...
          <Col xs="3" className="border">
            <Row className="py-5">
              <Col className="text-center" md="2" style={style.barcode1}>
                {/* <img src={barcode} alt='barcode'/> */}

                <img
                  src={`https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${detailBooking.data.passenger_name} \n ${detailBooking.data.origin} \n ${detailBooking.data.destination} \n ${detailBooking.data.code} `}
                  alt="barcode"
                />
              </Col>
            </Row>
